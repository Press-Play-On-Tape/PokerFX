...
convert_header(IMAGES + 'Titles/Pause.png',                                                    BASE + 'Images.hpp', 'Pause', 4, 64, 32)

convert_header(IMAGES + 'Cards/Cards.png',                                                     BASE + 'Images.hpp', 'Cards', 4, 36, 56)
convert_header(IMAGES + 'Cards/Cards_Back.png',                                                BASE + 'Images.hpp', 'Cards_Back', 4, 36, 56)
convert_header(IMAGES + 'Cards/Cards_Highlight.png',                                           BASE + 'Images.hpp', 'Cards_Highlight', 4)

convert_header(IMAGES + 'HUD.png',                                                             BASE + 'Images.hpp', 'HUD', 4)
convert_header(IMAGES + 'ArrowUpDown.png',                                                     BASE + 'Images.hpp', 'ArrowUpDown', 4)
convert_header(IMAGES + 'Frame_LH.png',                                                        BASE + 'Images.hpp', 'Frame_LH', 4)
convert_header(IMAGES + 'Frame_RH.png',                                                        BASE + 'Images.hpp', 'Frame_RH', 4)
